...
describe('CucumberExpression', function () {
    fs_1.default.readdirSync(testDataDir_js_1.testDataDir + "/expression").forEach(function (testcase) {
        var testCaseData = fs_1.default.readFileSync(testDataDir_js_1.testDataDir + "/expression/" + testcase, 'utf-8');
    ...
    fs_1.default.readdirSync(testDataDir_js_1.testDataDir + "/regex").forEach(function (testcase) {
        var testCaseData = fs_1.default.readFileSync(testDataDir_js_1.testDataDir + "/regex/" + testcase, 'utf-8');
        var expectation = js_yaml_1.default.load(testCaseData);
        it("" + testcase, function () {
            var parameterTypeRegistry = new ParameterTypeRegistry_js_1.default();
            var expression = new CucumberExpression_js_1.default(expectation.expression, parameterTypeRegistry);
    ...
    it('documents match arguments', function () {
        ...
        var expression = new CucumberExpression_js_1.default(expr, parameterTypeRegistry);
