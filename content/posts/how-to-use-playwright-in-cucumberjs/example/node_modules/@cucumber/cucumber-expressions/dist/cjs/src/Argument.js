...
var Argument = /** @class */ (function () {
    ...
    Argument.build = function (group, parameterTypes) {
        ...
        if (argGroups.length !== parameterTypes.length) {
            throw new CucumberExpressionError_js_1.default("Group has " + argGroups.length + " capture groups (" + argGroups.map(function (g) { return g.value; }) + "), but there were " + parameterTypes.length + " parameter types (" + parameterTypes.map(function (p) { return p.name; }) + ")");
        }
