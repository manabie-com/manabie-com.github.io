...
describe('RegularExpression', function () {
    it('documents match arguments', function () {
        ...
        var expression = new RegularExpression_js_1.default(expr, parameterRegistry);
    ...
    it('transforms float without integer part', function () {
        assert_1.default.deepStrictEqual(match(new RegExp("(" + ParameterTypeRegistry_js_1.default.FLOAT_REGEXP.source + ")"), '.22'), [0.22]);
    });
    it('transforms float with sign', function () {
        assert_1.default.deepStrictEqual(match(new RegExp("(" + ParameterTypeRegistry_js_1.default.FLOAT_REGEXP.source + ")"), '-1.22'), [-1.22]);
    });
